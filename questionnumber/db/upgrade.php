<?php
// local/questionnumber/db/upgrade.php

defined('MOODLE_INTERNAL') || die();

function xmldb_local_questionnumber_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2025061200) {
        ...
        upgrade_plugin_savepoint(true, 2025061200, 'local', 'questionnumber');
    }
