 ...
 */
function local_questionnumber_question_form_definition($mform, $question) {
    // Add a text input field for question_number
    $mform->addElement('text', 'question_number', get_string('questionnumber', 'local_questionnumber'), array('size' => '20'));
    ...
    $mform->addHelpButton('question_number', 'questionnumber', 'local_questionnumber');
 ...
 */
function local_questionnumber_question_save_question($question, $formdata) {
